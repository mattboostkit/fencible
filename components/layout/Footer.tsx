  ...
  return (
    <footer className="bg-bg-secondary border-t border-border-subtle">
      <Container>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3 mt-6">
              <a
                ...
                className="p-2 bg-bg-tertiary rounded-lg text-text-secondary hover:text-accent-primary hover:bg-bg-primary transition-colors"
                aria-label="Facebook"
              >
        ...
        {/* Bottom Bar */}
        <div className="py-6 border-t border-border-subtle flex flex-col sm:flex-row justify-between items-center gap-4">
